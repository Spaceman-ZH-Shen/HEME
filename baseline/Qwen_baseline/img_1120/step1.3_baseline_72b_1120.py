...
def get_args_parser():
    ...
    parser.add_argument('--model_dir', default=path_args.model_dir + '/Qwen2.5-VL-72B-Instruct/')
    parser.add_argument('--json_path', default=path_args.project_path + "/baseline/VG-RS-question.json")
    parser.add_argument('--json_save_path', default=path_args.project_path + '/knowledge/baseline_72b_1120.json')
    return parser

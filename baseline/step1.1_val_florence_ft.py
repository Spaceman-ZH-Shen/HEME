...
model_path = os.path.join(path_args.model_dir, 'Florence-2-large-ft')
...
output_json_path = path_args.project_path + "/baseline/baseline_results/baseline_florence2_ft.json"

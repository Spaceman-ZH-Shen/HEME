...
from img_size_transfer_tool.bbox_size_converter import transfer_1400_to_ori,transfer_ori_to_1120
path_args = get_args_parser().parse_args()

transfer_1400_to_ori(path_args.project_path + '/knowledge/step2_output_v1_1400.json', path_args.project_path + '/knowledge/step2_output_v1_1400_ori.json')
transfer_1400_to_ori(path_args.project_path + '/knowledge/step2_output_v2_1400.json', path_args.project_path + '/knowledge/step2_output_v2_1400_ori.json')
transfer_ori_to_1120(path_args.project_path + '/knowledge/step2_output_v1_1400_ori.json', path_args.project_path + '/knowledge/step2_output_v1_1400_1120.json')
transfer_ori_to_1120(path_args.project_path + '/knowledge/step2_output_v2_1400_ori.json', path_args.project_path + '/knowledge/step2_output_v2_1400_1120.json')
...
def get_args_parser():
    ...
    parser.add_argument('--json_save_path', default=path_args.project_path + '/knowledge/step2_output_v2_1120.json')
    ...
    parser.add_argument('--qwen72b_path_1120', default=path_args.project_path + '/knowledge/baseline_72b_1120.json')
    parser.add_argument('--qwen72b_path_1400', default=path_args.project_path + '/knowledge/baseline_72b_1400_1120.json')
    parser.add_argument('--qwen_v1_1120', default=path_args.project_path + '/knowledge/step2_output_v1_1120.json')
    parser.add_argument('--qwen_v1_1400', default=path_args.project_path + '/knowledge/step2_output_v1_1400_1120.json')
    parser.add_argument('--qwen_v2_1400', default=path_args.project_path + '/knowledge/step2_output_v2_1400_1120.json')
...
def main(args):
    ...
    qwen72b_path_1120_map = build_ref_result_map(load_json(args.qwen72b_path_1120))
    qwen72b_path_1400_map = build_ref_result_map(load_json(args.qwen72b_path_1400))
    qwen_v1_1120_map = build_ref_result_map(load_json(args.qwen_v1_1120))
    qwen_v1_1400_map = build_ref_result_map(load_json(args.qwen_v1_1400))
    qwen_v2_1400_map = build_ref_result_map(load_json(args.qwen_v2_1400))
    ...
    for sample in tqdm(data, desc="Processing with Chinese question input"):
        ...
        qwen72b_path_1120_result = qwen72b_path_1120_map.get(key, [])
        qwen72b_path_1400_result = qwen72b_path_1400_map.get(key, [])
        qwen_v1_1120_result = qwen_v1_1120_map.get(key, [])
        qwen_v1_1400_result = qwen_v1_1400_map.get(key, [])
        qwen_v2_1400_result = qwen_v2_1400_map.get(key, [])
        ...
        prompt_text = (
            ...
            f"The result of the image detection model: {qwen_v1_1120_result}, {qwen_v1_1400_result}, {qwen72b_path_1120_result}, {florence_result}, {qwen72b_path_1400_result}, {qwen_v2_1400_result}\n"
